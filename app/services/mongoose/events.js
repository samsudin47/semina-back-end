...
const createEvents = async(req) => {
    const { title, date, about, tagline, venueName, keyPoint, statusEvents, tickets, image, category, talent } = req.body;
...
const updateEvents = async(req) => {
    ...
    // cari event berdasarkan field id (Kamis 29 Des 2022 4.54 wib subuh)
    ...
    // cari Events dengan field name dan id selain dari yagn dikirim dari params
    ...
    const result = await Events.findOneAndUpdate({ _id: id }, {
        title,
        date,
        about,
        tagline,
